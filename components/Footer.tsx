...
export default function Footer() {
  return (
    <footer className="bg-[#111111] text-white pt-12 pb-6 px-6 md:px-12 border-t border-gray-800">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
        ...
        <div>
          ...
          <div className="flex space-x-2">
            <a href={FOOTER_SOCIALS.facebook} target="_blank" rel="noopener noreferrer" className="p-2.5 text-gray-400 hover:text-dais-red transition-colors" aria-label="Facebook">
              <Facebook className="w-6 h-6" />
            </a>
            <a href={FOOTER_SOCIALS.instagram} target="_blank" rel="noopener noreferrer" className="p-2.5 text-gray-400 hover:text-dais-red transition-colors" aria-label="Instagram">
              <Instagram className="w-6 h-6" />
            </a>
            <a href={`https://wa.me/${WHATSAPP_NUMBER}`} target="_blank" rel="noopener noreferrer" className="p-2.5 text-gray-400 hover:text-dais-red transition-colors" aria-label="WhatsApp">
            ...
            <a href={FOOTER_SOCIALS.tiktok} target="_blank" rel="noopener noreferrer" className="p-2.5 text-gray-400 hover:text-dais-red transition-colors" aria-label="TikTok">
              <svg viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
        ...
        <div>
          ...
          <ul className="space-y-4 text-gray-400">
            <li className="flex items-start space-x-3">
              <MapPin className="w-5 h-5 text-dais-red flex-shrink-0 mt-1" />
              <span>{ADDRESS}</span>
            </li>
            <li className="flex items-center space-x-3">
              <Phone className="w-5 h-5 text-dais-red flex-shrink-0" />
              <span>{PHONE_DISPLAY}</span>
            </li>
            <li className="flex items-center space-x-3">
              <Clock className="w-5 h-5 text-dais-red flex-shrink-0" />
      ...
      <div className="max-w-7xl mx-auto border-t border-gray-800 pt-6 text-center text-gray-500 text-sm">
